...
const RegistrationForm = () => {
  ...
  return (
    <div className="bg-slate-100 shadow-lg rounded-xl flex justify-center items-center flex-col p-3">
      <h1 className="text-2xl self-start">Registration Form</h1>
      <form className="flex flex-col p-4 gap-4 text-sm" autoComplete="off">
        ...
        <div className="flex justify-center  flex-col sm:flex-row items-center sm:gap-8">
          <div className="relative flex flex-col justify-center items-start">
            ...
            <input
              className="px-3 mb-4 uppercase py-2 rounded-lg shadow-lg border border-transparent focus:border-black outline-none"
              type="text"
              name="panNumber"
              id="panNumber"
